...
Процедура ЗагрузитьИсторию() Экспорт
	...
	// ??? Посмотреть переменную ВывестиСлужебнуюТаблицу
...
// ??? Обратить внимание на вывод ошибок. Где-то повторяется, где-то нет, но выглядит сложно.
...
Функция ПолучитьТЗИменаКлассов() 
	// ??? Выглядит странно. Стоит проверить конструктор ОписаниеТипов.
	Массив=Новый Массив;
...
Процедура СоединитьТаблицыТЗHistoryИТЗOBJECTS(ТЗHistory,ТЗOBJECTS)
	...
	// +++ Правильно использовать ПолучитьИмяВременногоФайла("xlsx");
...
// +++ Здесь и далее функции не стоит начинать с Получить, см. стандарт - https://its.1c.ru/db/v8std#content:647:hdoc
...
Функция ВыгрузитьТаблицыХранилищаВФайлы()
	// ??? Какая-то магия - стоит внимательнее присмотреться
